...
public class CommonConst
{
    ...
    /// 审批二次验证
    /// </summary>
    public const string SysApprovalPhoneCodeVerification = "sys_approval_phone_code_verification";
    ...
    /// 初训视频时长（分钟）
    /// </summary>
    public const string InitialTrainingVideoDuration = "initial_training_video_duration";

    /// <summary>
    /// 复训视频时长（分钟）
    /// </summary>
    public const string RetrainingVideoDuration = "retraining_video_duration";
}