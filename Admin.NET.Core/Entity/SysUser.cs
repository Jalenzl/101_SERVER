...
public class SysUser : EntityTenant
{
    ...
    /// 角色
    /// </summary>
    [Navigate(typeof(SysUserRole), nameof(SysUserRole.UserId), nameof(SysUserRole.RoleId))]//注意顺序
    ...
    /// 专业
    /// </summary>
    [SugarColumn(ColumnDescription = "专业", Length = 32)]
    [MaxLength(32)]
    ...
    /// 初次领证日期
    /// </summary>
    [SugarColumn(ColumnDescription = "初次领证日期")]
    ...
    /// IC编号
    /// </summary>
    [SugarColumn(ColumnDescription = "IC编号", Length = 200)]
    ...
    /// 密码过期时间
    /// </summary>
    [SugarColumn(ColumnDescription = "密码过期时间")]
