...
public class SysConfigSeedData : ISqlSugarEntitySeedData<SysConfig>
{
    ...
    public IEnumerable<SysConfig> HasData()
    {
        return new[]
        {
            ...
            new SysConfig{ Id=1300000000107, Name="开启图形验证码", Code="sys_captcha", Value="True", SysFlag=YesNoEnum.N, Remark="开启图形验证码", OrderNo=7, GroupCode="Default", CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
            ...
            new SysConfig{ Id=1300000000110, Name="开启审批短信二次验证", Code="sys_approval_phone_code_verification", Value="False", SysFlag=YesNoEnum.Y, Remark="开启审批短信二次验证", OrderNo=10, GroupCode="Default", CreateTime=DateTime.Parse("2026-03-03 00:00:00") },
        };
    }
}