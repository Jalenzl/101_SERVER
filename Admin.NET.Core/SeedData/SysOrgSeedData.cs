...
public class SysOrgSeedData : ISqlSugarEntitySeedData<SysOrg>
{
    ...
    public IEnumerable<SysOrg> HasData()
    {
        return new[]
        {
            new SysOrg{ Id=1300000000101, Pid=0, Name="数设科技", Code="1001", Type="101", Level=1, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), Remark="数设科技", TenantId=1300000000001 },
